            ...
            <div className="login__section--inner">
              <div className="row justify-content-center">
                <div className="col-lg-6 col-md-8 col-12">
                  <div className="account__tabs text-center mb-30">
                    <span 
                      className={`account__tab--link fw-bold ${activeTab === 'login' ? 'text-dark border-bottom border-primary border-2' : 'text-muted'}`} 
                      onClick={() => setActiveTab('login')}
                      style={{ cursor: 'pointer', paddingBottom: '5px', transition: 'all 0.3s ease' }}
                    >
                      Login
                    </span>
                    <span className="mx-3 text-muted">|</span>
                    <span 
                      className={`account__tab--link fw-bold ${activeTab === 'register' ? 'text-dark border-bottom border-primary border-2' : 'text-muted'}`} 
                    ...
                    <div className="card bg-white p-4 rounded shadow-sm">
                      <form onSubmit={handleRegisterSubmit}>
                        <div className="account__login register">
                          <div className="account__login--header mb-25">
                            <h2 className="account__login--header__title h3 mb-10">Create Account</h2>
                          ...
                          <div className="account__login--inner">
                            ...
                            <button className="account__login--btn btn mb-10" type="submit">Create Account</button>
