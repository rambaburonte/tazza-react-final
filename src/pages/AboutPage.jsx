                    ...
                    <div className="team__content ">
                      ...
                      <ul className="team__social d-flex justify-content-center align-items-center">
                        <li className="team__social--list">
                          <a className="team__social--icon" target="_blank" rel="noopener noreferrer" href="https://www.facebook.com">
                        ...
                        <li className="team__social--list">
                          <a className="team__social--icon" target="_blank" rel="noopener noreferrer" href="https://twitter.com">
                        ...
                        <li className="team__social--list">
                          <a className="team__social--icon" target="_blank" rel="noopener noreferrer" href="https://www.instagram.com">
                        ...
                        <li className="team__social--list">
                          <a className="team__social--icon" target="_blank" rel="noopener noreferrer" href="https://www.youtube.com">
