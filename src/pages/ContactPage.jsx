        ...
        <section className="contact__section section--padding">
          <div className="container">
            <div className="section__heading text-center mb-40">
              <span className="section__heading--subtitle">Cntact With Me</span>
                ...
                <div className="contact__info--items">
                  ...
                  <ul className="contact__info--social d-flex">
                    <li className="contact__info--social__list">
                      <a className="contact__info--social__icon" target="_blank" rel="noreferrer" href="https://www.facebook.com">
                    ...
                    <li className="contact__info--social__list">
                      <a className="contact__info--social__icon" target="_blank" rel="noreferrer" href="https://twitter.com">
                    ...
                    <li className="contact__info--social__list">
                      <a className="contact__info--social__icon" target="_blank" rel="noreferrer" href="https://www.instagram.com">
                    ...
                    <li className="contact__info--social__list">
                      <a className="contact__info--social__icon" target="_blank" rel="noreferrer" href="https://www.youtube.com">
