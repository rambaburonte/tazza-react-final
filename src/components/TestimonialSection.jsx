              ...
              <SwiperSlide key={testimonial.id}>
                <div className="testimonial__items d-flex align-items-center">
                  <div className="testimonial__items--thumbnail">
                    <img 
                      className="testimonial__items--thumbnail__img" 
                      src={`/assets/img/other/${testimonial.image}`} 
                      alt="testimonial-img" 
                    />
                  </div>
                  <div className="testimonial__items--content">
                    <h3 className="testimonial__items--title">{testimonial.name}</h3>
                    <span className="testimonial__items--subtitle">{testimonial.position}</span>
                    <p className="testimonial__items--desc">{testimonial.description}</p>
                    <div className="ratting testimonial__ratting">
                      <ul className="d-flex testimonial__ratting--inner">
                        {[1, 2, 3, 4, 5].map((star) => (
                          <li key={star} className="testimonial__ratting--list">
